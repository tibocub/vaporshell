...
CSRCS = alias.c arena.c arith.c builtins.c builtins_extra.c brace.c builtins_io.c dirs.c dispatch.c exec.c expand.c glob.c hash.c help.c inproc.c shopt.c lexer.c mode.c parser.c
