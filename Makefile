...
CSRCS = alias.c arena.c arith.c builtins.c builtins_extra.c builtins_io.c dispatch.c exec.c expand.c glob.c hash.c help.c inproc.c lexer.c mode.c parser.c
